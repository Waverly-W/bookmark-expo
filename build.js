...
// import {CRX_OUTDIR, CRX_CONTENT_OUTDIR, CRX_BACKGROUND_OUTDIR, CRX_NEWTAB_OUTDIR} from './globalConfig.js'
import {
  CRX_OUTDIR,
...
const newtabOutDir = path.resolve(process.cwd(), CRX_NEWTAB_OUTDIR);
